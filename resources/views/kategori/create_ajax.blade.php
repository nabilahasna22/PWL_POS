        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="kategoi_nama" id="kategoi_nama" class="form-control" required>
                    <small id="error-kategoi_nama" class="error-text form-text text-danger"></small>
                </div>
            </div>
