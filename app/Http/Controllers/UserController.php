    ...
    public function store_ajax(Request $request)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            if ($request->hasFile('foto')) {
                ...
                // Tambahkan path dan filename hanya jika foto diunggah
                $path .= $filename;
            }
            ...
            UserModel::create([
                ...
                'level_id'  => $request->level_id,
                'foto'      => $path // jika tidak ada foto, ini akan null
            ]);
    ...
    public function update_ajax(Request $request, $id)
{
    ...
    if ($request->ajax() || $request->wantsJson()) {
        ...
        if ($check) {
            ...
            // Inisialisasi variabel untuk path dan filename
            $path = null;
            $filename = null;
            ...
            // Jika 'foto' tidak ada, maka jangan update field 'foto'
            $updateData = [
                'username'  => $request->username,
                'nama'      => $request->nama,
                'password'  => $request->password ? bcrypt($request->password) : UserModel::find($id)->password,
    ...
    public function export_excel()
    {
        ...
        foreach ($user as $key => $value){
            $sheet->setCellValue('A'.$baris, $value->username);
            $sheet->setCellValue('B'.$baris, $value->nama);
            $sheet->setCellValue('C'.$baris, $value->level->level_nama);
            $baris++;
            $no++;
        }
